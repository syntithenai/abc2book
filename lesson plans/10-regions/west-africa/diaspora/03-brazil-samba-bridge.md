---
id: regions-africa-diaspora-03-brazil-samba-bridge
title: Samba and African Heritage
track: regions
region: africa-diaspora
tier: 4
difficulty: 6
prerequisites: ["regions-africa-diaspora-02-cuban-bridge"]
sources: ["West African Roots", "Diaspora"]
status: manual
---

# Samba and African Heritage

**Track:** West African Roots | **Unit:** Diaspora | **Tier:** 4

## Overview

Samba and related forms carry African rhythmic heritage in Brazil.
...
- A) Samba and related forms carry African rhythmic heritage in Brazil.
- B) Only hip-hop production
- C) Only ballet syllabus
- D) Only music engraving
**Answer:** A) Samba and related forms carry African rhythmic heritage in Brazil.
