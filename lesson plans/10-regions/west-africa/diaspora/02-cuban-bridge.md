---
id: regions-africa-diaspora-02-cuban-bridge
title: Cuban Clave and African Rhythm
track: regions
region: africa-diaspora
tier: 4
difficulty: 6
prerequisites: ["regions-africa-diaspora-01-blues-bridge"]
sources: ["West African Roots", "Diaspora"]
status: manual
---

# Cuban Clave and African Rhythm

**Track:** West African Roots | **Unit:** Diaspora | **Tier:** 4

## Overview

Cuban clave connects Caribbean dance music to African percussion concepts.
...
- A) Cuban clave connects Caribbean dance music to African percussion concepts.
- B) Only hip-hop production
- C) Only ballet syllabus
- D) Only music engraving
**Answer:** A) Cuban clave connects Caribbean dance music to African percussion concepts.
