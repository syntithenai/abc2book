---
id: regions-africa-diaspora-05-listening-across-borders
title: Atlantic Rhythm Listening Lab
track: regions
region: africa-diaspora
tier: 4
difficulty: 6
prerequisites: ["regions-africa-diaspora-04-colonial-archives"]
sources: ["West African Roots", "Diaspora"]
status: manual
---

# Atlantic Rhythm Listening Lab

**Track:** West African Roots | **Unit:** Diaspora | **Tier:** 4

## Overview

Compare Mali anchor recordings with diaspora blues, clave, and samba.
...
- A) Compare Mali anchor recordings with diaspora blues, clave, and samba.
- B) Only hip-hop production
- C) Only ballet syllabus
- D) Only music engraving
**Answer:** A) Compare Mali anchor recordings with diaspora blues, clave, and samba.
