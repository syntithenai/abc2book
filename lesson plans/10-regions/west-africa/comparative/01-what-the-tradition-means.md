---
id: regions-africa-comparative-01-what-the-tradition-means
title: What "West African Roots" Means
track: regions
region: africa-comparative
tier: 4
difficulty: 6
prerequisites: ["regions-africa-mali-01-overview"]
sources: ["West African Roots", "Comparative study"]
status: manual
---

# What "West African Roots" Means

**Track:** West African Roots | **Unit:** Comparative | **Tier:** 4

## Overview

Marketing labels flatten Mali and sibling nations — trad is regional, not one sound.
...
- A) Marketing labels flatten Mali and sibling nations — trad is regional, not one sound.
- B) Only opera staging
- C) Only synthesizer repair
- D) Only copyright law
**Answer:** A) Marketing labels flatten Mali and sibling nations — trad is regional, not one sound.
