---
id: regions-iberian-comparative-02-shared-instruments
title: Shared Instruments Compared
track: regions
region: iberian-comparative
tier: 4
difficulty: 6
prerequisites: ["regions-iberian-comparative-01-what-the-tradition-means"]
...
Fiddle, voice, pipes, and percussion appear across Iberian Folk with different roles.
...
- A) Fiddle, voice, pipes, and percussion appear across Iberian Folk with different roles.
- B) Only opera staging
- C) Only synthesizer repair
- D) Only copyright law
**Answer:** A) Fiddle, voice, pipes, and percussion appear across Iberian Folk with different roles.
