---
id: regions-south-diaspora-02-radio-archives
title: Radio and Archives Abroad
track: regions
region: south-diaspora
tier: 4
difficulty: 6
prerequisites: ["regions-south-diaspora-01-diaspora-communities"]
sources: ["South Asian Traditions", "Diaspora"]
status: manual
---

# Radio and Archives Abroad

**Track:** South Asian Traditions | **Unit:** Diaspora | **Tier:** 4

## Overview

Broadcasting and field archives shaped how Hindustani raga repertoire spread internationally.
...
- A) Broadcasting and field archives shaped how Hindustani raga repertoire spread int
- B) Only hip-hop production
- C) Only ballet syllabus
- D) Only music engraving
**Answer:** A) Broadcasting and field archives shaped how Hindustani raga repertoire spread int
...
### Q11. Anchor unit for this block is part of South Asian Traditions.
- A) True
- B) False
**Answer:** A) True
