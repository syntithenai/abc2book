---
id: regions-me-comparative-02-shared-instruments
title: Shared Instruments Compared
track: regions
region: me-comparative
tier: 4
difficulty: 6
prerequisites: ["regions-me-comparative-01-what-the-tradition-means"]
sources: ["Middle Eastern & Mediterranean Folk", "Comparative study"]
status: manual
---

# Shared Instruments Compared

**Track:** Middle Eastern & Mediterranean Folk | **Unit:** Comparative | **Tier:** 4

## Overview

Fiddle, voice, pipes, and percussion appear across Middle Eastern Folk with different roles.
...
- A) Fiddle, voice, pipes, and percussion appear across Middle Eastern Folk with different role
- B) Only opera staging
- C) Only synthesizer repair
- D) Only copyright law
**Answer:** A) Fiddle, voice, pipes, and percussion appear across Middle Eastern Folk with different role
...
### Q9. Middle Eastern & Mediterranean Folk includes multiple national units.
- A) True
- B) False
**Answer:** A) True
