---
id: regions-british-comparative-02-shared-instruments
title: Shared Instruments Compared
track: regions
region: british-comparative
tier: 4
difficulty: 6
prerequisites: ["regions-british-comparative-01-what-the-tradition-means"]
sources: ["British Isles Folk", "Comparative study"]
status: manual
---

# Shared Instruments Compared

**Track:** British Isles Folk | **Unit:** Comparative | **Tier:** 4

## Overview

Fiddle, voice, pipes, and percussion appear across British Isles Folk with different roles.
...
- A) Fiddle, voice, pipes, and percussion appear across British Isles Folk with different roles
- B) Only opera staging
- C) Only synthesizer repair
- D) Only copyright law
**Answer:** A) Fiddle, voice, pipes, and percussion appear across British Isles Folk with different roles
...
### Q9. British Isles Folk includes multiple national units.
- A) True
- B) False
**Answer:** A) True
