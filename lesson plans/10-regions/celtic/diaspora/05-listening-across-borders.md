---
id: regions-celtic-diaspora-05-listening-across-borders
title: Listening Across Borders
track: regions
region: celtic-diaspora
tier: 4
difficulty: 6
prerequisites: ["regions-celtic-diaspora-04-pan-celtic-festivals"]
status: manual
...
**Track:** Celtic Music | **Unit:** Diaspora & fringe | **Tier:** 4

## Overview

A guided comparative playlist approach: same tune family heard in Ireland, Scotland, Brittany, and diaspora settings.

## Compared with Ireland

Irish diaspora scenes (New York, Chicago, London) exported session culture and tune repertoire worldwide. This lesson traces how **listening across borders** relates to that network while developing its own accent.
...
*Explanation grounded in Listening Across Borders.*
