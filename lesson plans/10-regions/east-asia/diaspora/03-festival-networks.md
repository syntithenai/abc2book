---
id: regions-asia-diaspora-03-festival-networks
title: Festival Networks
track: regions
region: asia-diaspora
tier: 4
difficulty: 6
prerequisites: ["regions-asia-diaspora-02-radio-archives"]
...
Festivals link Japanese min'yō musicians with global folk networks and teaching camps.
...
- A) Festivals link Japanese min'yō musicians with global folk networks and teaching 
- B) Only hip-hop production
- C) Only ballet syllabus
- D) Only music engraving
**Answer:** A) Festivals link Japanese min'yō musicians with global folk networks and teaching 
