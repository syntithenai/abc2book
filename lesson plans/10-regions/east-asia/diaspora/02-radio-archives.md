---
id: regions-asia-diaspora-02-radio-archives
title: Radio and Archives Abroad
track: regions
region: asia-diaspora
tier: 4
difficulty: 6
prerequisites: ["regions-asia-diaspora-01-diaspora-communities"]
sources: ["East Asian Traditions", "Diaspora"]
status: manual
---

# Radio and Archives Abroad

**Track:** East Asian Traditions | **Unit:** Diaspora | **Tier:** 4

## Overview

Broadcasting and field archives shaped how Japanese min'yō repertoire spread internationally.
...
- A) Broadcasting and field archives shaped how Japanese min'yō repertoire spread int
- B) Only hip-hop production
- C) Only ballet syllabus
- D) Only music engraving
**Answer:** A) Broadcasting and field archives shaped how Japanese min'yō repertoire spread int
...
### Q11. Anchor unit for this block is part of East Asian Traditions.
- A) True
- B) False
**Answer:** A) True
