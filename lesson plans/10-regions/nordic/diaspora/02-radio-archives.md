---
id: regions-nordic-diaspora-02-radio-archives
title: Radio and Archives Abroad
track: regions
region: nordic-diaspora
tier: 4
difficulty: 6
prerequisites: ["regions-nordic-diaspora-01-diaspora-communities"]
sources: ["Nordic Folk", "Diaspora"]
status: manual
---

# Radio and Archives Abroad

**Track:** Nordic Folk | **Unit:** Diaspora | **Tier:** 4

## Overview

Broadcasting and field archives shaped how Norwegian slått repertoire spread internationally.
...
- A) Broadcasting and field archives shaped how Norwegian slått repertoire spread int
- B) Only hip-hop production
- C) Only ballet syllabus
- D) Only music engraving
**Answer:** A) Broadcasting and field archives shaped how Norwegian slått repertoire spread int
...
### Q11. Anchor unit for this block is part of Nordic Folk.
- A) True
- B) False
**Answer:** A) True
