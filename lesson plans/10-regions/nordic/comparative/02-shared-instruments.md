---
id: regions-nordic-comparative-02-shared-instruments
title: Shared Instruments Compared
track: regions
region: nordic-comparative
tier: 4
difficulty: 6
prerequisites: ["regions-nordic-comparative-01-what-the-tradition-means"]
...
Fiddle, voice, pipes, and percussion appear across Nordic Folk with different roles.
...
- A) Fiddle, voice, pipes, and percussion appear across Nordic Folk with different roles.
- B) Only opera staging
- C) Only synthesizer repair
- D) Only copyright law
**Answer:** A) Fiddle, voice, pipes, and percussion appear across Nordic Folk with different roles.
