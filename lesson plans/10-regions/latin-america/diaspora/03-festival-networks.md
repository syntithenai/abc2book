---
id: regions-latin-diaspora-03-festival-networks
title: Festival Networks
track: regions
region: latin-diaspora
tier: 4
difficulty: 6
prerequisites: ["regions-latin-diaspora-02-radio-archives"]
...
Festivals link Mexican son musicians with global folk networks and teaching camps.
...
- A) Festivals link Mexican son musicians with global folk networks and teaching camp
- B) Only hip-hop production
- C) Only ballet syllabus
- D) Only music engraving
**Answer:** A) Festivals link Mexican son musicians with global folk networks and teaching camp
