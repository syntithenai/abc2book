  ...
  function Footer(props) {
    ...
    if (location.pathname.startsWith('/print')) return null
     ...
     return <div style={{position:'fixed', bottom: 0, left: 0, width:'100%',display:'block',clear:'both',backgroundColor:'#e8f8fe', height:'1.2em'}} >
            ...
            {props.accessToken ? <Button style={{float:'right',fontSize:'0.6em', position:'relative', top:'2px'}} size="sm" variant="danger" onClick={props.revokeToken} >Logout</Button> : <Button style={{float:'left',fontSize:'0.6em', position:'relative', top:'2px'}} size="sm" variant="success" onClick={function() {initClient(); getToken()}} >Login</Button>}
