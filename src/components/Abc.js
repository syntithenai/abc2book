    ...
    if (!emergencyStop) {
      if (gtimingCallbacks && gtimingCallbacks.current && gmidiBuffer && gmidiBuffer.current) {
          ...
          if (seekTo > 0) { 
            ...
            var metronomeBeats = o.getBeatsPerMeasure() + 1
            // 2 bars where there is a pickup
            if (o.getPickupLength() > 0)  metronomeBeats = o.getBeatsPerMeasure() +  (o.getBeatsPerMeasure() - parseInt(o.getPickupLength()/o.getBeatLength())) + 1 
