...
export default function Header(props) {
    ...
    return <header className="App-header" style={{zIndex:11}}>
        ...
        {location.pathname.startsWith('/tunes/') && <span style={{float:'right'}} ><TempoControl  tunebook={props.tunebook} value={props.tempo} beatsPerBar={props.beatsPerBar} setBeatsPerBar={props.setBeatsPerBar} onChange={function(val) {props.setTempo(val)}}  /></span>}
    </header>
}
