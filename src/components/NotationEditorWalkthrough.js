...
export const WALKTHROUGH_STEPS = [
  ...
  },
  {
    ...
    body: [
      ...
      'Delete or Backspace turns selected notes into rests, removes selected rests, and removes selected bar lines. Underfull measures are padded automatically. Ctrl+Delete or Ctrl+Backspace removes selected events entirely.',
    ...
    tryIt: [
      ...
      'Select a rest and press Delete to remove it.',
  ...
  },
  {
    ...
    body: [
      ...
      'Clipboard: Ctrl+C/X/V copy/cut/paste, Ctrl+Shift+X swap, Delete (notes→rest, rests→remove), Ctrl+Delete remove.',
