...
export default function HomePage(props) {
    ...
    return <div className="App-home">
      ...
      <br/>
      <div>If you know what you want you can <Link to="/add"><Button size="sm">Add a Tune</Button></Link>, <Link to="/add/bulk"><Button size="sm">Bulk Import</Button></Link> a list of names, or use Curated Collections on the Add page for a ready-made tunebook.</div>
      <br/>
