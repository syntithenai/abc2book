...
export default function HelpPage(props) {
    ...
    <Tabs defaultActiveKey="home" id="uncontrolled-tab-example" className="mb-3">
      <Tab eventKey="home" title="Features">
        ...
        <ul>
          <li>Import ABC, MusicXML/MXL and MIDI music notation. MusicXML import works offline; MIDI import needs the media resolver.</li>
          ...
          <li>Link YouTube videos or audio files to tunes, adjust playback speed and pitch, and save practice loops.</li>
          ...
          <li>Search for lyrics, or transcribe lyrics from linked media and recordings when the media resolver is available.</li>
          <li>Generate ABC notation from chords and discover chords from linked media.</li>
          ...
          <li>Synchronise additions, edits and deletions between your devices so changes you make on your phone turn up on your computer.</li>
          <li>Listen to tunes and linked media, set the tempo, transpose playback, fine tune pitch and loop tricky sections.</li>
      ...
      <br/><br/>
      Once logged in, additions, edits and deletions in your Tune Book are saved to your Google Drive. <br/><br/>
      ...
      <br/><br/>
      If you log in to the same account on a different device, the software will attempt to synchronise your local database with the version stored online. If your local database needs to be updated, a list of changes will be shown along with choices to merge the changes, discard local differences or logout and ignore the version saved to Google Drive.
      <br/><br/>
      The green merge button will try to preserve changes everywhere by saving any locally changed tunes, updating any tunes changed or added online, and removing tunes that were deleted on another device.
      <br/><br/>
      When you merge, a <b>Deleted</b> tab lists tunes that will be removed locally because they were deleted elsewhere. This is part of normal delete synchronisation. Use <b>Discard Local Differences</b> if you want to keep tunes that only exist on this device.
      <br/><br/>
      Deletes made while logged out only affect the current device. Log in before deleting tunes if you want those deletions to be synchronised to your other devices.
      <br/><br/>
      The software checks regularly for changes to the Google Document so if you are logged in to two devices at the same time, changes on one device will appear within a few seconds as an import warning on your other device.
      <br/><br/>
      ...
      <Tab eventKey="resolver" title="Media Resolver">
      Some media features need help from a media resolver because browsers cannot directly process every audio, video or MIDI source.
      <br/><br/>
      ...
      <br/><br/>
      Linked media can also be adjusted for practice. Use the playback controls to slow down or speed up audio, transpose pitch, fine tune pitch and create named loops for difficult sections. These settings are saved with the tune.
      <br/><br/>
      ...
      The software library that turns an ABC string into printable music is also able to play the music. Where chords are annotated with the music, it will generate and play a piano accompaniment.
      <br/><br/>
      ...
      <br/><br/>
      If a tune has linked media and the media resolver is available, the <b>Listen</b> button in the chord wizard can analyse the audio and fill in a chord scaffold. Treat the result as a starting point and review it before saving.
      <br/><br/>
      ...
      <ul>
       ...
       <Tab eventKey="youtube" title="YouTube">
            ...
            <div className="c4 youtube-help-content">

            <p className="c1"><span className="c3"><h3>Selecting a YouTube link</h3></span></p><p className="c1 c2"><span className="c3"></span></p><p className="c1"><span className="c0">Click the blue button with the song title to view a tune.</span></p>
            <p className="c1"><span ><img alt="" src="helpimages/image3.png"  title="" /></span></p><p className="c1 c2"><span className="c0"></span></p><p className="c1"><span className="c0">Scroll up slightly to see the tune buttons and click the red media selection button.</span></p><p className="c1"><span ><img alt="" src="helpimages/image9.png"  title="" /></span></p><p className="c1 c2"><span className="c3"></span></p><p className="c1 c2"><span className="c0"></span></p><p className="c1"><span className="c0">Click &quot;Search YouTube&quot;</span></p><p className="c1"><span ><img alt="" src="helpimages/image10.png"  title="" /></span></p><p className="c1 c2"><span className="c0"></span></p><p className="c1 c2"><span className="c3"></span></p><p className="c1"><span className="c0">In the resulting dialog, click the green Select button to choose a YouTube video to associate with the tune record.</span></p><p className="c1"><span ><img alt="" src="helpimages/image7.png" title="" /></span></p><p className="c1 c2"><span className="c0"></span></p><p className="c1 c2"><span className="c0"></span></p><p className="c1 c2"><span className="c0"></span></p><p className="c1 c2"><span className="c0"></span></p>
            <p className="c1"><span>&#8203;</span><span className="c3"><h3>Logging In</h3></span></p><p className="c1 c2"><span className="c0"></span></p><p className="c1"><span className="c5">To import and export a playlist, you need to first log in</span><span className="c0">&nbsp;(with Google) using the green button in the menu.</span></p><p className="c1 c2"><span className="c0"></span></p><p className="c1"><span ><img alt="" src="helpimages/image5.png"  title="" /></span></p><p className="c1 c2"><span className="c0"></span></p>
            <p className="c1"><span className="c3"><h3>Exporting a book to a YouTube playlist</h3></span></p><p className="c1 c2"><span className="c0"></span></p>
            <p className="c1"><span className="c0">The tunebook software can behave as a playlist manager in a web browser. This has limits as an audio player around device screen locking.</span></p><p className="c1"><span className="c0">By exporting a book of tunes with YouTube links that a user is interested in, it is possible to play them through the official YouTube app or voice controlled devices like Google Nest.</span></p><p className="c1 c2"><span className="c0"></span></p><p className="c1 c2"><span className="c0"></span></p><p className="c1"><span className="c0">Go to the Books page by clicking the first menu item.&#8203;</span></p>
            <p className="c1"><span ><img alt="" src="helpimages/image1.png"  title="" /></span></p><p className="c1 c2"><span className="c0"></span></p><p className="c1"><span className="c0">Click the dropdown arrow next to one of your books to see a dialog with options for the book including &quot;Export YouTube Playlist&quot;</span></p>
            <p className="c1"><span ><img alt="" src="helpimages/image2.png"  title="" /></span></p><p className="c1 c2"><span className="c0"></span></p><p className="c1 c2"><span className="c0"></span></p>
            <p className="c1"><span className="c0">Clicking the &quot;Export YouTube Playlist&quot; button will create a YouTube playlist and playlist items for the logged in user for up to 50 items in the book.</span></p>
            <p className="c1"><span ><img alt="" src="helpimages/image4.png"  title="" /></span></p><p className="c1 c2"><span className="c0"></span></p><p className="c1 c2"><span className="c0"></span></p>
            <p className="c1"><span className="c3"><h3>Importing a playlist</h3></span></p>
            <p className="c1"><span className="c0">&#8203;Importing a playlist from YouTube can be a quick start to collecting a genre or artist in the Tune Book.</span></p><p className="c1 c2"><span className="c0"></span></p>
            <p className="c1"><span className="c0">The green &quot;Import&quot; button on the books and list pages brings up a dialog with import options.</span></p>
            <p className="c1"><span ><img alt="" src="helpimages/image11.png"  title="" /></span></p><p className="c1 c2"><span className="c0"></span></p><p className="c1 c2"><span className="c0"></span></p><hr /><p className="c1 c2"><span className="c0"></span></p><p className="c1 c2"><span className="c0"></span></p><p className="c1"><span className="c0">Click the button to import from YouTube</span></p><p className="c1 c2"><span className="c0"></span></p>
            <p className="c1"><span ><img alt="" src="helpimages/image12.png"  title="" /></span></p><p className="c1 c2"><span className="c0"></span></p><p className="c1 c2"><span className="c0"></span></p><p className="c1 c2"><span className="c0"></span></p>
            <p className="c1"><span className="c0">Paste the id of a YouTube playlist or select one of the logged in user's playlists to import.</span></p>
            <p className="c1"><span className="c0">Importing playlist items creates tune records with a title and a YouTube link for every playlist item that is not already in the local tune database.</span></p><p className="c1 c2"><span className="c0"></span></p><p className="c1"><span ><img alt="" src="helpimages/image8.png"  title="" /></span></p><p className="c1 c2"><span className="c0"></span></p><p className="c1 c2"><span className="c0"></span></p><p className="c1 c2"><span className="c0"></span></p></div>
      </Tab>
...
<br/><br/>
There are many websites offering folk and bluegrass tunes in ABC format so wanting tools to help me import, select and fix tunes into arrangements as I know them with chords has directed the development. Editing ABC notation is a bit technical but in developing tools to make things faster for me I hope it is a bit more accessible. 
<br/><br/>
...
<br/><br/>
It is possible to create decent sounding music with ABC to MIDI and good soundfonts, however most of what I have curated has been minimal: a clunky auto generated piano harmony and optionally the melody. It is a practice/organisation tool.
<br/><br/>
Associating YouTube tracks with tunes makes listening to a practice list much more pleasant.
<br/><br/>
<hr/>
MusicXML is the widespread standard for distributing detailed musical scores. Tools like MuseScore offer the ability to deal with complicated music.
