...
describe('playbackTimingMap', function() {
  test('header-only tune exposes opening meter and tempo', function() {
    ...
    const headerQpm = typeof visual.getBpm === 'function' ? visual.getBpm() : 120
    expect(map).not.toBeNull()
    expect(map.startingMeter).toBe('4/4')
    expect(map.startingQpm).toBeCloseTo(headerQpm, 1)
    ...
    expect(atStart.qpm).toBeCloseTo(headerQpm, 1)
